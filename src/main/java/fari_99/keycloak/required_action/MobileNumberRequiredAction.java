...
public class MobileNumberRequiredAction implements RequiredActionProvider {
	...
	public static final String PROVIDER_ID = "phone-number-ra";
	private static final String UPDATE_MOBILE_NUMBER_FORM = "update-mobile-number.ftl";
	private static final String MOBILE_NUMBER_FIELD = "phoneNumbers";
	...
	private Response createForm(RequiredActionContext context, Consumer<LoginFormsProvider> formConsumer) {
		...
		return form.createForm(UPDATE_MOBILE_NUMBER_FORM);
	}
